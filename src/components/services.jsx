        ...
        <div className="w-full pb-24 bg-[#102111] relative">
            ...
            <section className="h-full w-full py-16 px-10">
                ...
                <section className="flex justify-between mt-16">
                    <img loading="lazy" src={service1Img} className="h-[30rem]" alt="" />
                    <img loading="lazy" src={service2Img} className="h-[30rem]" alt="" />
                    <img loading="lazy" src={service3Img} className="h-[30rem]" alt="" />
                </section>
            </section>
        </div>
    )
